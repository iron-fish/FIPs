---
title: Fish Improvement Proposal Process
---
...
Once your idea is well formulated, and you’re ready to write an improvement proposal, please first read [FIP-0](/fips/fip-0) and use it as a starting point. Once you have your draft, please make a pull request (PR) to the [FIP repository](https://github.com/iron-fish/FIPs).
...
- **Idea** - This is when the FIP is still a PR and not merged into the FIP repository. Please make sure you have discussed it on [Discourse](https://discourse.ironfish.network/) first.
